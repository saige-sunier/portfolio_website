            ...
            <div className="aboutMe-div" id="about">
                ...
                <div className="aboutMe-content">
                    ...
                    <div className="aboutMe-text-div">
                        ...
                        <p className="aobutMe-text">I spend almost every weekend hiking, skiing, or running. Logging miles on my sneakers or carving the slopes in the mountains has always been my way to escape to my thoughts. It is a time where I feel re-centered, challenged, and inspired. </p>
                        <p className="aboutMe-text">Despite my habit of long runs in solitude, I am a very extroverted person. Throw me into a room with a whiteboard and a group of people tossing around ideas and I won’t even need coffee. I bring passion and energy to every project that I am on and I have always prioritized listening and learning from others. </p>
